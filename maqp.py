...
from ensemble_creation.uniform import create_uniform_ensemble
...
from schemas.appian.schema import gen_appian_schema
...
if __name__ == '__main__':
    ...
    elif args.dataset == 'appian':
        schema = gen_appian_schema(table_csv_path)
    else:
